...
# ╔═╡ c2411616-aa13-11ed-00ec-dfe98e4de03f
using Plots, FFTW, PlutoUI

# ╔═╡ 4dcbfd0e-b807-4111-b10e-03f2c02cda65
...
# ╔═╡ 67fb0dda-de93-4394-8390-bd1f0484e5f6
md"""##### Set base frequency"""

# ╔═╡ 0d5424c0-b96a-4bf8-a378-93b258af7502
@bind f Radio(["2" => "2 Hz", "4" => "4 Hz"], default="2")

# ╔═╡ 1a545b67-be8a-4c06-bfa2-46ddbc343ec6
...
# ╔═╡ 7d816b88-a62e-4ee5-9bbc-8b6490c67c7b
md""" Set the sampling frequency using the  slider below"""

# ╔═╡ 98e8c57c-b60f-425a-ae7c-b529ffc71808
@bind FS Slider(100:-1:2)

# ╔═╡ 1f5edd59-a4c2-486f-8759-bb15769ce32c
begin
	fs1 = 100
	ts1 = 0:(1/fs1):π
	fs2 = 2
...
# ╔═╡ 780c571e-f321-43f5-bfba-1ef365fb603d
begin
	fi = parse(Int32, f)
...
# ╔═╡ 3d58f9e4-8735-4998-9d76-b60318b65513
...
# ╔═╡ 06249d64-416a-4b19-9079-eb510189e809
begin
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "229407525917ed98ff8062c7ce0d0c7a79e33572"
