...
\begin{tikzpicture}[every node/.style={outer sep=0pt},thick,
 ...
 \draw[line width=1mm] (-0.1,-0.3) -- (-0.1,0.3);}]
  ...
  \node[mass,minimum width=3.5cm,minimum height=2cm,fill=green!50!black] (m1) {$m$};
 ...
 \draw[spring]  (m1.east|-aux) -- (g2.west|-aux) node[midway,above=1mm]{$k_2$};
...
%
%  \foreach \X in {1,2}  
  \draw[thin] (g2.north) -- ++ (0,1) coordinate[midway](aux1);
  \draw[latex-] (aux1) -- ++ (-0.5,0) node[above]{$F$}; 
