...
# ╔═╡ 81eee3a0-b246-11ed-1ba3-a39ac65a76c2
# ╠═╡ show_logs = false
using Plots, DSP, FFTW, MAT, Interpolations, Plots.Measures

# ╔═╡ 5ce81e57-5402-4d59-95e4-f96b6f9caa72
md""" 
...
# ╔═╡ 963c6661-2f50-4dda-a9c7-ee9d245206e2
...
# ╔═╡ 68c5fae2-2e6b-47c5-acee-c241b058b8cc
...
# ╔═╡ 812a1922-ff6a-4022-a926-2365fcca3ab8
begin
...
# ╔═╡ 9a2a0787-f1d5-49ec-ad62-0965152dac8c
...
# ╔═╡ e575f598-3e55-4fb2-a2b1-d9034d4ac453
md"""#### Switching to even sampling"""

# ╔═╡ 3a438885-05d2-494a-82ad-11671f59db2c
begin
	t_pre = vec(ws["t_pre"])
	t_med = vec(ws["t_med"])
...
# ╔═╡ c1060ba6-8911-4782-99f2-ebdb6a66ffc5
...
# ╔═╡ 21d806c0-ca10-421b-ac04-85701469f909
pre_ex, med_ex = map(extrema, [t_pre, t_med])

# ╔═╡ 44779225-e9ac-44d7-91f4-4c8928bcb081
...
# ╔═╡ c7d32b4b-8e1d-4020-8a4d-7dc77ac88ff2
begin
	fs = 100
	dt = 1/fs
...
# ╔═╡ f4c96161-6f2e-47f3-8978-111086c4a35f
...
# ╔═╡ 86909abd-3169-417f-8ccc-17ebccb253ab
...
# ╔═╡ ac3f3722-522f-43a6-aa10-eaf946798435
...
# ╔═╡ d30897d0-49c2-4b8b-a4b9-7dcb617f7f02
...
# ╔═╡ c8663825-18eb-4643-82dd-fc215e875668
...
# ╔═╡ 8846c68e-aab9-43dd-b288-a8d6062bdf3d
md""" ### Averaging 
...
# ╔═╡ e9b6802e-96f8-4711-9c97-a64635fe8396
md"""### Example 4.6"""

# ╔═╡ 4be40ae9-7039-4425-acbc-7f75122015d5
...
# ╔═╡ 78ce3288-bf2d-4079-bed2-397e40156f3a
...
# ╔═╡ 41a10644-5821-4ccf-9b09-d7cee95ff737
begin
...
# ╔═╡ a45028aa-301c-4821-84a1-81b3622f6c3d
begin
...
# ╔═╡ 95f9d727-542e-48e6-86d7-ad6052e76288
begin
...
# ╔═╡ f5eb319c-ff46-4254-a996-9315275a5d6f
begin
struct Foldable{C}
    title::String
    content::C
...
# ╔═╡ bc082bf3-36e4-44bd-8d9d-a6ce83e9a5ce
...
# ╔═╡ e3002155-a1b1-4ea4-a856-3f0384555a3c
Foldable("MATLAB Code",md"""
```matlab
figure
subplot(1, 2, 2)
...
# ╔═╡ 6fb37064-e916-4e84-a06e-21fd9ed8fe72
Foldable("MATLAB Code", md"""
```matlab
tpre_min = min(t_pre);
tpre_max = max(t_pre);
...
# ╔═╡ 9458e30b-a9a0-41af-9998-71b2fa6075a2
Foldable("MATLAB Code", md"""
```matlab
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "d5b6d76dabe70a931c290d1e7100c006449ed2c6"
