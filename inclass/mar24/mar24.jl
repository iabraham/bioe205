...
# ╔═╡ 6643f8b8-c9a5-11ed-1c6e-fb8b6558c5f6
using Plots, ControlSystemsBase, Plots.Measures, PlutoUI

# ╔═╡ 649773c7-2716-4aac-8c71-3c019fd522f5
...
# ╔═╡ b405cd82-da5f-4249-933f-684651637984
md"""Draw asymptotes: $(@bind p1_asymptotes CheckBox(default=false))"""

# ╔═╡ 39a61b8d-e889-4139-b4ea-53abb4ed3ecf
begin
	num1 = [1/2, 1]
	den1 = [1]
	p1func(x) = x/2
...
# ╔═╡ eec4689b-527f-4fd5-a1ac-37de19d24402
md"""#### Problem 2

Draw asymptotes: $(@bind p2_asymptotes CheckBox(default=false))
"""

# ╔═╡ 926f8b38-5ffd-4eef-81ab-59b19c22a3b6
begin
	num2 = [900]
	den2 = [1, 12, 900]
...
# ╔═╡ 51221bc5-e56e-495d-8504-3606b8bd39e1
md"""## Bode plots
...
begin
	...
	outlayed = plot(pp1, pp2, layout=(1,2),size=(800, 350), bottom_margin=3mm, left_margin=2mm)
	p3sol ? bb : outlayed
end
