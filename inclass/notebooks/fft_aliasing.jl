...
# ╔═╡ 46895134-ab24-11ed-17c9-5951d2fb3b68
using Plots, FFTW, PlutoUI

# ╔═╡ 7bd07834-879c-4303-8896-23b6f46f238b
module fixedParams
	using Plots, FFTW
	ts1 = 0:(1/100):π
...
# ╔═╡ 1c89b805-66c9-4054-943b-cd70bed5a0e9
...
# ╔═╡ 962d5e48-e70c-4d6f-93f0-c4c7591f9426
fixedParams.pp

# ╔═╡ a7b47ae5-186e-4365-9efd-8e248ae42f27
md"""The radio buttons below will add a different frequency sinewave to the original signal."""

# ╔═╡ 963703ab-b5c7-4f76-aad5-c87a2180f009
@bind adf Radio(["1" => "1 Hz", "2" => "2 Hz", "6" => "6 Hz", "10"=>"10 Hz"], default="1")

# ╔═╡ 81c17b27-b84c-41e7-8dec-240fee6c51c2
begin
	fs1 = 100
	ts1 = 0:(1/fs1):π
...
# ╔═╡ f745971e-b2d8-4274-9ffa-e63f81f28e37
