...
# ╔═╡ c62decb0-c75d-11ed-33e4-ad806d431221
using ControlSystemsBase, PlutoUI, Plots

# ╔═╡ 4f6bcb22-870b-4736-bc5c-4f1effd315eb
md"""# Bode primitives demo"""

# ╔═╡ d42d96aa-3f8c-4847-abb3-9cab5569dd9b
md"""## Type 2 terms
...
# ╔═╡ 7dee4785-92ec-461b-b1ed-56e5466d410a
begin
	type2_numerator = [1]
	type2_denominator = [τ_2, 1]
	type2_sys = tf(type2_numerator, type2_denominator)
...
# ╔═╡ 82e9e012-3248-48ef-9881-aacd396dfc62
md""" ## Type 3 terms
...
# ╔═╡ 73660e63-0547-4b75-a5b9-d84a2ffbda01
begin
	type3_numerator = [1]
	type3_denominator = [1/ω^2, 2*ζ/ω, 1]
	typ3sys = tf(type3_numerator, type3_denominator)
	typ3sys_inv = tf(type3_denominator, type3_numerator)
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "0b848278f06c23a27e3209fea4b5517bab345974"
