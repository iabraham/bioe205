...
- **Physiological variability/indeterminacy:** This is noise that enters a
  ...
  material to our objective. Noise due to physiological indeterminacy are one
  of the hardest forms of noise to account for in analysis.
...
equations[^3]. For example, sine wave, cosine wave, square wave, etc. are all
...
population cannot grown unbounded forever. 
...
nonstationary signals. Nonstationarities present a moving target to any analysis
